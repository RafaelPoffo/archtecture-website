...
const Features = () => {
    return (
        <div className='min-h-screen flex justify-center flex-col md:px-32 px-5 p-4 m-2'>
            <div className='flex flex-col md:flex-row items-center space-y-5'>
                ...
                <div>
                    <div>
                        <h1 className='text-4xl font-playFair font-medium text-center'>Build your needs with Archmove</h1>
                    </div>
                    ...
                    <div className='flex flex-row gap-5 p-5 md:pl-24'>
                        ...
                        <div>
                            ...
                            <p className='w-4/5 text-slate-300'>Build safe, comfortable and transparent with a project management application with a joint account.</p>
                        </div>
                    </div>
                </div>
            </div>
